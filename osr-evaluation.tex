...
A description of the benchmarks is reported in \mytable\ref{tab:OSR-alC-bench-desc}.

\begin{table}[t]
\begin{center}
\begin{small}
\newcolumntype{D}{>{\centering\arraybackslash}m{0.95cm}}
\begin{tabular}{ |c|c|c|c|c|c|c|c|c|c| }
        \cline{3-10}
        \multicolumn{2}{l|}{} & \multicolumn{6}{c|}{Optimizations} & \multicolumn{2}{c|}{Utils} \\
        \hline
...
%\end{adjustbox}
\end{center}
\caption{\label{tab:OSR-alC-bench-desc} Description of the benchmarks.} 
\end{table}
