...
\noindent A simple amortized analysis argument can be used to show that the amortized running time of tree pruning is constant as well.
\mynote{Write an informal proof}
