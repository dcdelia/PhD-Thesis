...
\ifauthorea{\newline}{}
\noindent By proving that {\tt find-min} requires constant amortized time, we finally show that an {\tt update} operation can be performed in constant time during the MCCT construction:
\begin{theorem}
%\vspace{-2mm}
