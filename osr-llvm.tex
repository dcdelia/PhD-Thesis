...
\mynote{Deferred compilation, case study}
...
OSR is used as part of an automatic, online, profile-driven deferred compilation mechanism. The specialized code used by Jikes is essentially equivalent to the continuation function generated by our framework. % discuss constants being hard-wired in it
