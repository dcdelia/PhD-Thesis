...
set key on at 10.26,117.5 maxrows 1 samplen 3 font ",16"
set title "Breakdown of feasible OSR points (f_{opt}{/Symbol \256} f_{base})" offset 0,2 font ",20"
...
plot \
     'data/opt-to-base.csv' using (100*$3/$2):xtic(1) t '{/Symbol c = \341 \361}' fs ls 2,\
